...
export function ComparadorPaises({ paises }: PropiedadesComparadorPaises) {
  if (paises.length !== 2) {
    return null;
  }
      ...
      <div className="flex items-center justify-between border-b border-border px-4 py-3">
        <div>
          ...
          <h2 className="mt-1 text-sm font-medium text-foreground">
            {primerPais.nombre} y {segundoPais.nombre}
          </h2>
        </div>
